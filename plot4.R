...
#plot the data 
#par(mar = c(4,6,2,2),fg = "black",mfrow=c(2,2))
par(fg = "black",mfrow=c(2,2))

#upper left plot
plot(data$DateTime,as.numeric(data$Global_active_power),type="l",col="black",xlab="",ylab="Global Active Power",yaxt = "n",ylim=c(0,8))
axis(side=2,at=seq(0,6,2),labels=seq(0,6,2))

# upper right plot
plot(data$DateTime,as.numeric(data$Voltage),type="l",col="black",xlab="datetime",ylab="Voltage")
...
#lower right plot
plot(data$DateTime,as.numeric(data$Global_reactive_power),type="l",col="black",xlab="datetime",ylab="Global_rective_power",yaxt = "n",ylim=c(0,0.5))
